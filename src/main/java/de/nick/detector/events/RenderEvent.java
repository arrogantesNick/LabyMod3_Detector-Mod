...
public class RenderEvent {
    ...
    public void onRender(RenderGameOverlayEvent e) {
        if(DetectorMOD.SERVER_IP != null) {
            if(DetectorMOD.SERVER_IP.contains("gommehd.net") || DetectorMOD.SERVER_IP.contains("cw-bw.net") || DetectorMOD.SERVER_IP.contains("cw-bw.de") ||DetectorMOD.SERVER_IP.contains("frostic.net")) {
